...
int main(int argc, char* argv[])
{
	...
	Matrice* m =
		nullptr;    //pointeur matrice initialiser a nullptr puisque le constructeur utiliser depend des arguments donné
	bool verbose{ false };    //verbose corespend a imprimer de facon detailler fle terminale par default false
	...
	if (m != nullptr)    //s'assure que la matrice a etait générer
	{
		for (int i = 0; i < argc; ++i)
		{
			if (strcmp(argv[i], "-A") == 0)		//on ultilise touts les critére de descision
			{
